...
<div class="leading-relaxed text-[#5c5f77] dark:text-[#cdd6f4]">
	...
	<p class="mb-4">
		...
		<a
			...
			class="text-[#1e66f5] hover:underline dark:text-[#89b4fa]">Universitas Brawijaya</a
	...
	<p class="">
		Right now, I’m focused on growing as a backend and AI engineer. Outside of tech, you’ll usually
		find me playing chess or listening to way too much music.
	</p>
</div>
